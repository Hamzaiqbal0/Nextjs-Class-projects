  ...
  return (
    <div className="container mx-auto p-8 bg-gray-100">
      ...
      <div className="flex justify-between mt-8">
        <Image
          src="https://cache2.pakwheels.com/system/car_generation_pictures/6432/original/Haval_H6_Front.jpg?1652179573"
          alt="Car 1"
        ...
        />
        <Image
          src="https://www.electrive.com/media/2024/08/byd-seal-bev-02-2024-jpeg-e1723203231806.jpeg"
          alt="Car 2"
          className="w-1/4 rounded-lg shadow-md"
          width={400}
          height={300}
        />
        <Image
          src="https://cache1.pakwheels.com/system/car_generation_pictures/6407/original/BMW_iX_Front.jpg?1650874000"
          alt="Car 3"
          className="w-1/4 rounded-lg shadow-md"
          width={400}
          height={300}
